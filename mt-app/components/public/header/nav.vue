    ...
    <ul class="nav">
      ...
      <li class="list bd">
        ...
        <dl>
          ...
          <dd><nuxt-link to="/shouyin">美团智能收银</nuxt-link></dd>
          <dd><nuxt-link to="/hezuo">我想合作</nuxt-link></dd>
          <dd><nuxt-link to="/kaidian">手机免费开店</nuxt-link></dd>
          <dd><nuxt-link to="/zhaomu">餐饮代理商招募</nuxt-link></dd>
          <dd><nuxt-link to="/kaipiao">商家申请开票</nuxt-link></dd>
          <dd><nuxt-link to="/paidui">免费合作美团排队</nuxt-link></dd>
        </dl>
      </li>
      <li class="list site">
